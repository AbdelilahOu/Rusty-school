...
use service::{models::CClass, *};
//
type StBody = ActJson<CClass>;

pub async fn create_class(body: StBody, state: State) -> HttpRes {
...
pub async fn update_class(id: IdParam, body: StBody, state: State) -> HttpRes {
    let update_res =
