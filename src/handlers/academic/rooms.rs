...
//
pub async fn create(body: Json<Room>, state: State) -> Response {
...
pub async fn list(query: Query<RoomQuery>, state: State) -> Response {
...
pub async fn update(id: Path<Uuid>, body: Json<Room>, state: State) -> Response {
    let res =
