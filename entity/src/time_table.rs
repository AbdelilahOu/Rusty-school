...
use super::sea_orm_active_enums::TimeTableItemCategories;
use super::sea_orm_active_enums::WeekDays;
...
pub struct Model {
    ...
    pub id: Uuid,
    pub item_type: TimeTableItemCategories,
    pub day_of_week: Option<WeekDays>,
